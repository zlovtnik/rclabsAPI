...
using ConfigValueTypes = boost::hana::tuple<
    boost::hana::type<int>,
    boost::hana::type<double>,
    boost::hana::type<std::string>,
    boost::hana::type<bool>
>;
...
constexpr auto count_strong_ids(boost::hana::tuple<boost::hana::type<Types>...>) {
    return boost::hana::size(
        boost::hana::filter(
            boost::hana::make_tuple(boost::hana::type_c<Types>...),
            [](auto type) {
