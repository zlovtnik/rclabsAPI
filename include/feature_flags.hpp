...
public:
    ...
    static constexpr const char* NEW_CONCURRENCY_PATTERNS = "new_concurrency_patterns";
    ...
    bool shouldEnableForUser(const std::string& flag, const std::string& userId) const;
