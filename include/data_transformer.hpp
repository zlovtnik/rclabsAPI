...
private:
    ...
    std::string applyTransformation(const std::string& value, const TransformationRule& rule);
    std::string applyStringTransformation(const std::string& value, const std::string& type, 
                                        const std::unordered_map<std::string, std::string>& params);
    std::string applyNumericTransformation(const std::string& value, const std::string& type,
                                         const std::unordered_map<std::string, std::string>& params);
};
