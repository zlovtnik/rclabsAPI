...
public:
    ...
    void setRecoveryConfig(const websocket_recovery::ConnectionRecoveryConfig& config);
    const websocket_recovery::ConnectionRecoveryConfig& getRecoveryConfig() const { return recoveryConfig_; }
    const websocket_recovery::ConnectionRecoveryState& getRecoveryState() const { return recoveryState_; }
