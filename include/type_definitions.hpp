...
// Define the strong ID types using Hana tuples for better metaprogramming
// support
using StrongIdTypes =
    boost::hana::tuple<boost::hana::type<class JobIdTag>,
...
template <typename Tag> struct hash<etl::StrongId<Tag>> {
