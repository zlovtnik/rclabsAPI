...
enum class ErrorCode {
    ...
    // Authentication/Authorization errors (2000-2999) - Consolidated from 5 to 4 codes
    ...
    DATABASE_ERROR = 3000,       // Covers CONNECTION_FAILED, QUERY_FAILED, TRANSACTION_FAILED, DEADLOCK_DETECTED
    NETWORK_ERROR = 3001,        // Covers REQUEST_TIMEOUT, CONNECTION_REFUSED, INVALID_RESPONSE, SERVICE_UNAVAILABLE
    FILE_ERROR = 3002,           // Covers FILE_NOT_FOUND, PERMISSION_DENIED
    MEMORY_ERROR = 3003,         // Covers OUT_OF_MEMORY, RESOURCE_EXHAUSTED
    CONFIGURATION_ERROR = 3004,  // Covers CONFIG_NOT_FOUND, CONFIG_PARSE_ERROR, INVALID_CONFIG_VALUE, MISSING_CONFIG_SECTION
    ...
    PROCESSING_FAILED = 4003,    // Covers JOB_EXECUTION_FAILED, EXTRACT_FAILED, LOAD_FAILED
    TRANSFORMATION_ERROR = 4004, // Covers DATA_TRANSFORMATION_ERROR
    DATA_INTEGRITY_ERROR = 4005  // New - covers data validation and consistency issues
};
