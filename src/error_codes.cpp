...
const std::unordered_map<ErrorCode, ErrorCodeInfo> &getErrorCodeInfo() {
  static const std::unordered_map<ErrorCode, ErrorCodeInfo> errorInfo = {
      ...
      {ErrorCode::INVALID_INPUT,
       {
           "Invalid input data or format", "Validation",
           false, // Not retryable - client error
           400    // Bad Request
       }},
      {ErrorCode::MISSING_FIELD,
       {"Required field is missing", "Validation", false, 400}},
      {ErrorCode::INVALID_RANGE,
       {"Value is outside acceptable range", "Validation", false, 400}},
      {ErrorCode::CONSTRAINT_VIOLATION,
       {
           "Data violates business or database constraints", "Validation",
           false,
           409 // Conflict
       }},
      ...
      {ErrorCode::UNAUTHORIZED,
       {
           "Authentication required or credentials invalid", "Authentication",
           false,
           401 // Unauthorized
       }},
      {ErrorCode::FORBIDDEN,
       {
           "Access forbidden - insufficient permissions", "Authorization",
           false,
           403 // Forbidden
       }},
      {ErrorCode::TOKEN_EXPIRED,
       {"Authentication token has expired", "Authentication", false, 401}},
      {ErrorCode::ACCESS_DENIED,
       {"Access denied to requested resource", "Authorization", false, 403}},

      // System errors
      {ErrorCode::DATABASE_ERROR,
       {
           "Database operation failed", "System",
           true, // Retryable - might be transient
           500   // Internal Server Error
       }},
      {ErrorCode::NETWORK_ERROR,
       {
           "Network communication failed", "System", true,
           502 // Bad Gateway
       }},
      {ErrorCode::FILE_ERROR,
       {"File system operation failed", "System", true, 500}},
      {ErrorCode::MEMORY_ERROR,
       {
           "Memory allocation or resource exhaustion", "System", true,
           503 // Service Unavailable
       }},
      {ErrorCode::CONFIGURATION_ERROR,
       {"Configuration loading or parsing failed", "System",
        false, // Usually requires manual intervention
        500}},
      {ErrorCode::LOCK_TIMEOUT,
       {"Lock acquisition timeout", "System", true, 503}},
      {ErrorCode::RATE_LIMIT_EXCEEDED,
       {
           "Request rate limit exceeded", "System",
      ...
      {ErrorCode::THREAD_POOL_EXHAUSTED,
       {"Thread pool capacity exceeded", "System", true, 503}},
      {ErrorCode::SERVICE_STARTUP_FAILED,
       {"Service initialization failed", "System", false, 500}},
      {ErrorCode::COMPONENT_UNAVAILABLE,
       {"Required component is unavailable", "System", true, 503}},
      {ErrorCode::INTERNAL_ERROR,
       {"Unexpected internal error", "System", false, 500}},

      // Business logic errors
      {ErrorCode::JOB_NOT_FOUND,
       {
           "Requested job does not exist", "Business", false,
           404 // Not Found
       }},
      {ErrorCode::JOB_ALREADY_RUNNING,
       {
           "Job is already in running state", "Business", false,
           409 // Conflict
       }},
      {ErrorCode::INVALID_JOB_STATE,
       {"Job is in invalid state for requested operation", "Business", false,
        409}},
      {ErrorCode::PROCESSING_FAILED,
       {"Data processing operation failed", "Business",
        true, // Might be retryable depending on cause
        500}},
      {ErrorCode::TRANSFORMATION_ERROR,
       {
           "Data transformation failed", "Business",
           false, // Usually data-specific
           422    // Unprocessable Entity
       }},
      {ErrorCode::DATA_INTEGRITY_ERROR,
       {"Data integrity validation failed", "Business", false, 422}}};
...
std::string errorCodeToString(ErrorCode code) {
  ...
  case ErrorCode::THREAD_POOL_EXHAUSTED:
    return "THREAD_POOL_EXHAUSTED";
  case ErrorCode::SERVICE_STARTUP_FAILED:
    return "SERVICE_STARTUP_FAILED";
...
std::string getMigrationInfo(LegacyErrorCode legacyCode) {
  ...
  case LegacyErrorCode::INVALID_TYPE:
    info +=
        " - Consolidated into INVALID_INPUT for simpler validation handling";
    break;
  case LegacyErrorCode::QUERY_FAILED:
  case LegacyErrorCode::TRANSACTION_FAILED:
  case LegacyErrorCode::DEADLOCK_DETECTED:
    info += " - Consolidated into DATABASE_ERROR with specific details in "
            "error context";
    break;
  case LegacyErrorCode::REQUEST_TIMEOUT:
  case LegacyErrorCode::CONNECTION_REFUSED:
    info +=
        " - Consolidated into NETWORK_ERROR for unified network error handling";
    break;
  default:
    break;
  }
