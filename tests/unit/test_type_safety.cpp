...
TEST_F(TypeSafetyTest, TypeTraits) {
  ...
  EXPECT_TRUE((std::is_same_v<template_utils::strong_id_value_type_t<JobId>,
                              std::string>));
  EXPECT_TRUE(
      (std::is_same_v<template_utils::strong_id_value_type_t<ConnectionId>,
                      std::string>));
  EXPECT_TRUE((std::is_same_v<template_utils::strong_id_value_type_t<UserId>,
                              std::string>));
}
