...
int main() {
    ...
    CONFIG_LOG_INFO("Configuration loaded successfully - Template System Working!");
    ...
    ETL_LOG_INFO_JOB("Job processing started - Template System Working!", "job_123");
    ETL_LOG_DEBUG_JOB("Processing data batch - Template System Working!", "job_123");
    ETL_LOG_INFO_JOB("Job completed successfully - Template System Working!", "job_123");
