...
int main() {
    try {
        ...
        std::cout << "✓ JobMonitorService initialized and started successfully" << std::endl;
        ...
        jobMonitorService->onJobStatusChanged(activeJobId, JobStatus::PENDING, JobStatus::RUNNING);
