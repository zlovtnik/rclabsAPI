...
TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_FromConfig_ValidConfiguration) {
...
TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_Validate_ValidConfiguration) {
    auto wsConfig = configManager->getWebSocketConfig();
...
TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_Validate_InvalidPort) {
    ...
    EXPECT_THAT(result.errors[0], testing::HasSubstr("port must be between 1 and 65535"));
}

TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_Validate_PrivilegedPortWarning) {
    WebSocketConfig config;
    config.port = 80;
...
TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_Validate_InvalidMaxConnections) {
    WebSocketConfig config;
    ...
    EXPECT_FALSE(result.isValid);
    EXPECT_GE(result.errors.size(), 1);
    EXPECT_THAT(result.errors[0], testing::HasSubstr("max_connections must be positive"));
}

TEST_F(ConfigManagerMonitoringTest, WebSocketConfig_Validate_HighMaxConnectionsWarning) {
    WebSocketConfig config;
...
TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_FromConfig_ValidConfiguration) {
...
TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_FromConfig_DefaultValues) {
    // Create config with minimal settings
    std::ofstream file(testConfigFile);
...
TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_Validate_ValidConfiguration) {
    auto jtConfig = configManager->getJobTrackingConfig();
...
TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_Validate_InvalidProgressUpdateInterval) {
    ...
    EXPECT_FALSE(result.isValid);
    EXPECT_GE(result.errors.size(), 1);
    EXPECT_THAT(result.errors[0], testing::HasSubstr("progress_update_interval must be positive"));
}

TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_Validate_HighProgressUpdateIntervalWarning) {
    JobTrackingConfig config;
...
TEST_F(ConfigManagerMonitoringTest, JobTrackingConfig_Validate_InvalidTimeoutThreshold) {
    JobTrackingConfig config;
    ...
    EXPECT_FALSE(result.isValid);
    EXPECT_GE(result.errors.size(), 1);
    EXPECT_THAT(result.errors[0], testing::HasSubstr("timeout_warning_threshold must be positive"));
}
...
TEST_F(ConfigManagerMonitoringTest, MonitoringConfig_FromConfig_ValidConfiguration) {
...
TEST_F(ConfigManagerMonitoringTest, MonitoringConfig_Validate_ValidConfiguration) {
    auto monitoringConfig = configManager->getMonitoringConfig();
...
TEST_F(ConfigManagerMonitoringTest, MonitoringConfig_Validate_InvalidWebSocketConfiguration) {
...
TEST_F(ConfigManagerMonitoringTest, MonitoringConfig_Validate_CrossValidationWarning) {
    ...
    EXPECT_TRUE(result.isValid);
    EXPECT_GE(result.warnings.size(), 1);
    EXPECT_THAT(result.warnings[0], testing::HasSubstr("progress update interval"));
}
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_UpdateWebSocketConfig_ValidUpdate) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_UpdateWebSocketConfig_InvalidUpdate) {
    WebSocketConfig newConfig;
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_UpdateJobTrackingConfig_ValidUpdate) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_UpdateJobTrackingConfig_InvalidUpdate) {
    JobTrackingConfig newConfig;
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_UpdateMonitoringConfig_ValidUpdate) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_ConfigChangeCallback_Registration) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_ConfigChangeCallback_Unregistration) {
    bool callbackInvoked = false;
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_ReloadConfiguration_ValidFile) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_ReloadConfiguration_InvalidFile) {
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_GetValidatedValue_IntWithValidator) {
    auto value = configManager->getValidatedValue<int>("monitoring.websocket.port", 8080, 
        [](int port) { return port > 0 && port <= 65535; });
    
    EXPECT_EQ(value, 8081);  // From config file
}

TEST_F(ConfigManagerMonitoringTest, ConfigManager_GetValidatedValue_IntWithValidatorFailure) {
    auto value = configManager->getValidatedValue<int>("monitoring.websocket.port", 8080, 
...
TEST_F(ConfigManagerMonitoringTest, ConfigManager_GetValidatedValue_StringWithValidator) {
    auto value = configManager->getValidatedValue<std::string>("monitoring.websocket.enabled", "false", 
