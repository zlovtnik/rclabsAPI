...
int main() {
    ...
    std::cout << "   Current file needs rotation? " << (manager.needsRotation() ? "YES" : "NO") << std::endl;
    ...
    std::cout << "   Files created: " << metrics.totalFilesCreated.load() << std::endl;
    std::cout << "   Files rotated: " << metrics.totalFilesRotated.load() << std::endl;
    std::cout << "   Bytes written: " << metrics.totalBytesWritten.load() << std::endl;
    std::cout << "   Write operations: " << metrics.totalWriteOperations.load() << std::endl;
