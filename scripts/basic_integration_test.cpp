...
int main() {
    ...
    try {
        ...
        std::cout << "✓ notification_service.hpp included successfully" << std::endl;
        ...
        std::cout << "✓ WebSocket connection count: " << connectionCount << std::endl;
        ...
        std::cout << "All monitoring component headers are properly structured." << std::endl;
        ...
        std::cerr << "\n❌ Basic integration test failed with exception: " << e.what() << std::endl;
        return 1;
    }
}