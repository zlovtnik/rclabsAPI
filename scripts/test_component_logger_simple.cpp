...
namespace etl {
    ...
    void ComponentLogger<Component>::log_debug(const char* component, const std::string& message) {
        std::cout << "[DEBUG][" << component << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_info(const char* component, const std::string& message) {
        std::cout << "[INFO][" << component << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_warn(const char* component, const std::string& message) {
        std::cout << "[WARN][" << component << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_error(const char* component, const std::string& message) {
        std::cout << "[ERROR][" << component << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_fatal(const char* component, const std::string& message) {
        std::cout << "[FATAL][" << component << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_info_job(const char* component, const std::string& message, const std::string& jobId) {
        std::cout << "[INFO][" << component << "][Job:" << jobId << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_error_job(const char* component, const std::string& message, const std::string& jobId) {
        std::cout << "[ERROR][" << component << "][Job:" << jobId << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_debug_job(const char* component, const std::string& message, const std::string& jobId) {
        std::cout << "[DEBUG][" << component << "][Job:" << jobId << "] " << message << std::endl;
    }

    template<typename Component>
    void ComponentLogger<Component>::log_warn_job(const char* component, const std::string& message, const std::string& jobId) {
        std::cout << "[WARN][" << component << "][Job:" << jobId << "] " << message << std::endl;
    }
}
...
int main() {
    ...
    std::cout << "\n1. Testing compile-time component name resolution..." << std::endl;
    std::cout << "ETLJobLogger component: " << ETLJobLogger::get_component_name() << std::endl;
    std::cout << "WebSocketLogger component: " << WebSocketLogger::get_component_name() << std::endl;
    std::cout << "RequestLogger component: " << RequestLogger::get_component_name() << std::endl;
    std::cout << "DatabaseLogger component: " << DatabaseLogger::get_component_name() << std::endl;
    ...
    WebSocketLogger::info("Client {} connected from {}", "user123", "192.168.1.100");
